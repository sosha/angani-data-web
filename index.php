...
<section class="auth-shell"><div class="panel auth-card"><div class="eyebrow">Reset password</div><h1>Forgot your password?</h1><?php if($resetSent): $resetToken=getv('token'); $resetEmail=getv('e'); ?>
<p class="muted">If that email exists, a reset link has been generated. You can also use the link below directly:</p>
<p><a class="linkish" href="?page=reset&token=<?=e($resetToken)?>&e=<?=e($resetEmail)?>"><?=e(public_url_prefix())?>?page=reset&token=<?=e($resetToken)?>&e=<?=e($resetEmail)?></a></p>
<p class="muted">The link expires in 60 minutes.</p>
<?php else: ?>
